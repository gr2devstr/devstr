...
BEGIN
    ...
    INSERT ALL
        ...
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, LIST_VALUE_ID)
                 VALUES (4, COMMENT_ID.CURRVAL, 40)                       -- 4 = ROLE; 39 = DEVELOPER.
...
BEGIN
    ...
    INSERT ALL
        ...
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, VALUE)
                 VALUES (6, COMMENT_ID.CURRVAL, '9Str0ng#%passW0rD!6')    -- 6 = PASSWORD.
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, LIST_VALUE_ID)
                 VALUES (7, COMMENT_ID.CURRVAL, 41)                       -- 7 = STATUS; 41 = ACTIVE.
    SELECT * FROM DUAL;
END;
/
...
BEGIN
    ...
    INSERT ALL
        ...
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, LIST_VALUE_ID)
                 VALUES (4, COMMENT_ID.CURRVAL, 37)                       -- 4 = ROLE; 37 = PROJECT_MANAGER.
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, DATE_VALUE)
                 VALUES (5, COMMENT_ID.CURRVAL, SYSDATE)                  -- 5 = CREATION_DATE.            
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, VALUE)
                 VALUES (6, COMMENT_ID.CURRVAL, '9Str0ng#%passW0rD!6')    -- 6 = PASSWORD.
...
BEGIN
    ...
    INSERT ALL
        ...
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, LIST_VALUE_ID)
                 VALUES (4, COMMENT_ID.CURRVAL, 38)                       -- 4 = ROLE; 38 = TECHNICAL_MANAGER.
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, DATE_VALUE)
                 VALUES (5, COMMENT_ID.CURRVAL, SYSDATE)                  -- 5 = CREATION_DATE.            
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, VALUE)
                 VALUES (6, COMMENT_ID.CURRVAL, '9Str0ng#%passW0rD!6')    -- 6 = PASSWORD.
...
BEGIN
    ...
    INSERT ALL
        ...
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, LIST_VALUE_ID)
                 VALUES (4, COMMENT_ID.CURRVAL, 39)                       -- 4 = ROLE; 39 = GROUP_MANAGER.
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, DATE_VALUE)
                 VALUES (5, COMMENT_ID.CURRVAL, SYSDATE)                  -- 5 = CREATION_DATE.            
        INTO ATTRIBUTES (ATTRN_ID, OBJECT_ID, VALUE)
                 VALUES (6, COMMENT_ID.CURRVAL, '9Str0ng#%passW0rD!6')    -- 6 = PASSWORD.
